    ...
    <form class="form-horizontal" action='' method="POST" style="margin-left: 20px">
        <fieldset>
            ...
            <div class="control-group">
                <!-- Button -->
                <div class="controls">
                    <button id="btnReg" class="btn btn-success" >Register</button>
                </div>
            </div>
        </fieldset>
    </form>
...
<script>
    ...
    document.getElementById("btnReg").addEventListener("click",validateEmail);
...
function resetEmailField(){
    document.getElementById("email").style="border-color: black";
}</script>
