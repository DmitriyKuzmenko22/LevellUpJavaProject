...
//}
        ...
        while (true) {
            ...
            switch (operator) {
                ...
                case "-":
                if (a instanceof Integer && b instanceof Integer) {
                    System.out.println((a + operator + b) + " = " + calc.vich((Integer) a, (Integer) b));
                    break;
                } else System.out.println((a + operator + b) + " = " + calc.vich((Double) a, (Double) b));
                break;
                case "*":
                    if (a instanceof Integer && b instanceof Integer) {
                        System.out.println((a + operator + b) + " = " + calc.umn((Integer) a, (Integer) b));
                        break;
                    } else System.out.println((a + operator + b) + " = " + calc.umn((Double) a, (Double) b));
                    break;
                case "/":
                    if (a instanceof Integer && b instanceof Integer) {
                        System.out.println((a + operator + b) + " = " + calc.del((Integer)a, (Integer)b));
                        break;
                    } else System.out.println((a + operator + b) + " = " + calc.del((Double) a, (Double) b));
                    break;
                default:
            }
